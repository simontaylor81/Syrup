...
namespace ShaderEditorApp.Rendering
{
	...
	class Camera
	{
		...
		public ViewModel.ViewportViewModel ViewportViewModel { get; set; }
			...
			return (o, e) =>
				{
					...
					{
						case ViewModel.ViewportViewModel.CameraMode.Orbit:
							orbitHandler(o, e);
							break;

						case ViewModel.ViewportViewModel.CameraMode.Walk:
							walkHandler(o, e);
							break;
					}
				};
		...
		private void MouseWheel(object sender, MouseEventArgs e)
		{
			...
			if (ViewportViewModel.SelectedCameraMode == ViewModel.ViewportViewModel.CameraMode.Orbit)
				orbitRadius += deltaRadius;
